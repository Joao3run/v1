...
import vertex from "../public/assets/shader/vertex.glsl";
import fragment from "../public/assets/shader/fragment.glsl";
...
export class Sketch {
    ...
    addObjects() {
        ...
        this.material = new THREE.ShaderMaterial({
            ...
            uniforms: {
                time: {value: 0},
                uColor1: {value: new THREE.Color(0xFF3333)},
                uColor2: {value: new THREE.Color(0xa00f16)},
                uColor3: {value: new THREE.Color(0x80090C)},
        ...
        const sprite = new THREE.TextureLoader().load('/assets/model/disc.png');
